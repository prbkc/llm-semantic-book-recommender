...
This repo contains all of the code to build this project which is "A Semantic Book Recommender with LLMs". There are five components in this project:
...
In order to create your vector database, you'll need to create a .env file in your root directory containing your OpenAI API key or you can use a free open source alternative.
